## 2026-04-10 - Optimize Component Static Arrays & Filtering
...
**Action:** When finding multiple  lines for stats alongside general list filtering, refactor them into a single pass block using  that evaluates all constraints at once.
