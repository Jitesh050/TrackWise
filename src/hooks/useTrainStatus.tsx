...
// Re-export types for compatibility if needed, though they seem unused externally
...
const TRAINS_DATA: SimTrain[] = getAllTrains()
// No need for SCHEDULES_DATA array anymore
