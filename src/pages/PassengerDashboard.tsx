...
const PassengerDashboard = () => {
  ...
  // Bolt ⚡ Optimization: Consolidate multiple O(N) array passes (filter, map, reduce)
  // into a single useMemo loop. Also hoisted the STATIONS_BY_CODE map outside the component
  ...
  const { activeBookings, nextJourney, milesTraveled } = useMemo(() => {
    ...
    const nextStr = closestTime === Infinity
      ? "No upcoming"
      : new Date(closestTime).toLocaleString();
