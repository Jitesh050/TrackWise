...
const PassengerDashboard = () => {
  ...
  const { activeBookings, hasBookings, latestPnr, nextJourney, milesTraveled } = useMemo(() => {
    // Optimization: Memoize all dashboard statistics to prevent expensive
    // O(N) array filtering and date parsing on every render cycle.
    // This reduces CPU overhead significantly for users with many tickets.
