...
// Hoist static station lookup outside component to prevent O(N) reallocation per render
...
const PassengerDashboard = () => {
  ...
  // Consolidate multiple iterative array passes into a single loop to calculate passenger stats
  const {
    activeBookings,
    hasBookings,
    latestPnr,
    ...
    const pnr = hasAny ? (tickets[0]?.pnr || "") : "";
