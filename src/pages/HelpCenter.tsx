...
const HelpCenter = () => {
  ...
  // ⚡ Bolt: Memoize filtered FAQs and hoist toLowerCase() evaluation outside the filter loop
  // This prevents redundant O(N) filtering array operations and string transformations on every render
