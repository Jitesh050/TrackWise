...
const StationInfo = () => {
  ...
  const stations = useMemo(() => {
    ...
    // OPTIMIZATION: Hoisted .toLowerCase() evaluation outside the filter loop to prevent O(N) re-allocations.
    // Wrapped in useMemo to prevent redundant array recreation on every render.
