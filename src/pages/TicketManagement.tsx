...
const TicketManagement = () => {
  ...
  // ⚡ Bolt: Consolidated 3 O(N) filter passes into a single O(N) reduce pass to optimize stat calculations
  const stats = useMemo(() => {
  ...
  // ⚡ Bolt: Wrapped filtering in useMemo and hoisted toLowerCase() to prevent redundant calculations on re-renders
