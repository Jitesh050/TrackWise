...
const TicketManagement = () => {
  ...
  // ⚡ Bolt: Cache stats calculation to avoid multiple O(N) array traversals on every render
  const stats = useMemo(() => {
  ...
  // ⚡ Bolt: Memoize filtered array and hoist lowercasing to avoid O(N) string creations
