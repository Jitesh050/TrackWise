...
const TicketManagement = () => {
  ...
  // ⚡ Bolt: Consolidate multiple O(N) passes for ticket stats into a single O(N) reduce
  ...
  // ⚡ Bolt: Wrap in useMemo and hoist toLowerCase to prevent redundant operations per render
