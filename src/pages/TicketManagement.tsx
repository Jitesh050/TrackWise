...
const TicketManagement = () => {
  ...
  const { filteredTickets, confirmedCount, waitingCount, cancelledCount } = React.useMemo(() => {
    ...
    return tickets.reduce(
      (acc, ticket) => {
        ...
        if (ticket.status === "Waiting") acc.waitingCount++;
        if (ticket.status === "Cancelled") acc.cancelledCount++;

        return acc;
      },
      { filteredTickets: [], confirmedCount: 0, waitingCount: 0, cancelledCount: 0 } as {
        filteredTickets: typeof tickets;
