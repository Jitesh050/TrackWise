...
const TicketManagement = () => {
  ...
  // ⚡ Bolt Optimization: Memoize filtered array to prevent recalculation on every render
  // Hoist searchTerm.toLowerCase() outside the filter loop to avoid redundant string allocations
  ...
  // ⚡ Bolt Optimization: Consolidate three separate O(N) .filter().length passes
