...
const TicketManagement = () => {
  ...
  // ⚡ Bolt Optimization: Wrap filtering in useMemo and hoist search term parsing
  ...
  // ⚡ Bolt Optimization: Consolidate multiple unmemoized O(N) array filtering passes into one O(N) reduce pass
  const stats = useMemo(() => {
