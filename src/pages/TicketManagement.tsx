...
const TicketManagement = () => {
  ...
  // ⚡ Bolt Optimization: Consolidate multiple O(N) filter.length passes into a single O(N) reduce pass
  ...
  // ⚡ Bolt Optimization: Memoize filtered tickets and hoist toLowerCase to avoid recalculation
