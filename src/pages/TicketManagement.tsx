...
const TicketManagement = () => {
  ...
  const { filteredTickets, stats } = useMemo(() => {
    ...
    for (let i = 0; i < tickets.length; i++) {
      ...
      // Update stats
      if (ticket.status === "Confirmed") result.stats.confirmed++;
      else if (ticket.status === "Waiting") result.stats.waiting++;
      else if (ticket.status === "Cancelled") result.stats.cancelled++;
    ...
    return { filteredTickets: result.filtered, stats: result.stats };
